---
title: "pathtpx Simulation Model 2"
author: "Kushal K Dey"
date: "7/5/2017"
...
```{r}
source("../../R/pathcount.R")
source("../../R/pathtpx.R")
source("../../R/pathtopics.R")
set.seed(100)
```
...
```{r echo=TRUE, eval=FALSE}
save(topic_clus, file = "../output/pathtpx_sim_2_10000.rda")
```


```{r echo=TRUE}
topic_clus <- get(load("../output/pathtpx_sim_2_10000.rda"))
```
...
```{r echo=TRUE, eval=FALSE}
save(topic_clus, file = "../output/pathtpx_sim_2_100.rda")
```


```{r echo=TRUE}
topic_clus <- get(load("../output/pathtpx_sim_2_100.rda"))
```
